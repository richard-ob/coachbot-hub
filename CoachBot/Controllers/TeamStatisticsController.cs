...
namespace CoachBot.Controllers
{
    ...
    public class TeamStatisticsController : Controller
    {
        ...
        {
            return _matchStatisticsService.GetTeamStatistics(pagedRequest.Page, pagedRequest.PageSize, pagedRequest.SortOrderFull, pagedRequest.TimePeriod, pagedRequest.TeamId, pagedRequest.TournamentEditionId);
        }
