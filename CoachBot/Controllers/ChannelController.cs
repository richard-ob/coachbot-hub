...
namespace CoachBot.Controllers
{
    ...
    public class ChannelController : Controller
    {
        ...
        {
            _matchmakerService.ConfigureChannel(
                channel.Id,
                channel.Team1.Name,
                channel.Positions,
                channel.RegionId,
                channel.Team1.KitEmote,
                channel.Team1.BadgeEmote,
                channel.Team1.Color,
                channel.IsMixChannel,
                channel.Formation,
                channel.ClassicLineup,
                channel.DisableSearchNotifications,
                channel.EnableUnsignWhenPlayerStartsOtherGame
            );
        }
    }
}
